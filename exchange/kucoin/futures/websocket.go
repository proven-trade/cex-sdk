...
const (
	DefaultProPublicWebSocketURL = "wss://x-push-futures.kucoin.com"
...
// StreamClientConfig는 KuCoin Classic·Pro Futures WebSocket 설정이다.
...
// StreamClient는 KuCoin Classic·Pro Futures WebSocket 세션을 생성한다.
...
// NewStreamClient는 KuCoin Classic·Pro Futures WebSocket 클라이언트를 생성한다.
func NewStreamClient(config StreamClientConfig) (*StreamClient, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("invalid KuCoin Futures Pro public WebSocket URL: %w", err)
	}
